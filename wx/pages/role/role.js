...
Page({
  ...
  select: function(e) {
    ...
    if (!local_roles.has(selected_id)) {
      local_array[selected_id].color = "green";
      local_roles.add(selected_id)
    } else {
      local_array[selected_id].color = "blue";
      local_roles.delete(selected_id)
    }
    this.setData({
      array: local_array,
      roles: [...local_roles]
